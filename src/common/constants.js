...
export default {
  ...
  userTypeFn: () => (global.mUserType === 'M' ? 'M' : 'B'),
  baseColorFn: () => (global.mUserType === 'M' ? '#000000' : '#7ea1b2'),
  baseXColorFn: () => (global.mUserType === 'M' ? '#7ea1b2' : '#000000'),
  baseXColorDirect: userType => (userType === 'M' ? '#7ea1b2' : '#000000'),
  white: '#ffffff',
  black: '#000000',
  blue: '#0046ff',
  red: '#ee002c',
