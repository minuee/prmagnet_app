...
export default {
  ...
  getUserType: () => (global.mUserType === 'M' ? 'M' : 'B'),
  getBaseColor: () => (global.mUserType === 'M' ? '#000000' : '#7ea1b2'),
  getBaseXColor: () => (global.mUserType === 'M' ? '#7ea1b2' : '#000000'),
  getBaseXColorDirect: userType => (userType === 'M' ? '#7ea1b2' : '#000000'),
  white: '#ffffff',
  black: '#000000',
  blue: '#0046ff',
  red: '#ee002c',
