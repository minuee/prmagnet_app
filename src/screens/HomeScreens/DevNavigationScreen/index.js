...
const screens = [
  ...
  ['브랜드-연결시트-리턴2', 'https://zpl.io/beQ3ngq', 'LinkSheetDetailScreen'],
  ['브랜드-연결시트-리턴밀기', 'https://zpl.io/bl9Kyme', 'LinkSheetDetailScreen'],
  ['브랜드-연결시트-리턴팝업', 'https://zpl.io/bJeD5qr', 'LinkSheetDetailScreen'],
  ['브랜드-연결시트-리턴체크완료', 'https://zpl.io/VYeqwBM', ''],
  ['브랜드-연결시트-노티피케이션', 'https://zpl.io/b6LKZMR', 'LinkSheetDetailScreen'],
  ['브랜드-연결시트-노티피케이션1', 'https://zpl.io/aRe4rYv', 'LinkSheetDetailScreen'],
  ['브랜드-연결시트-샌드아웃', 'https://zpl.io/bALRjq8', 'LinkSheetScreen'],
  ...
  ['연결시트-전화걸기', 'https://zpl.io/2vw9MlQ', 'LinkSheetDetailScreen'],
  ...
  ['Sample Requests-리스트', 'https://zpl.io/bALRjBo', 'SampleRequestsListScreen'],
  ['Sample Requests-수정/삭제', 'https://zpl.io/bWe8KNk', 'SampleRequestsListScreen'],
  ['Sample Requests-삭제', 'https://zpl.io/VYeqwrp', 'SampleRequestsListScreen'],
  ['Sample Requests-삭제완료', 'https://zpl.io/a3LE31d', 'SampleRequestsListScreen'],
  ...
  ['스케쥴-By Brands 검색', 'https://zpl.io/a3LE3jd', 'ByBrandsSearchScreen'],
  ['연결시트-날짜선택', 'https://zpl.io/agj3ekA', 'SelectScheduleScreen'],
  ['매거진-연결시트-픽업', 'https://zpl.io/25L4ZpQ', 'LinkSheetScreen'],
  ['매거진-연결시트-픽업2', 'https://zpl.io/29Lm4Kd', 'LinkSheetDetailScreen'],
  ['매거진-연결시트-From-밀기', 'https://zpl.io/bzr3k6z', ''],
  ['매거진-연결시트-From팝업', 'https://zpl.io/25L4Zp0', 'LinkSheetDetailScreen'],
  ['매거진-연결시트-From체크완료', 'https://zpl.io/Vx738wm', ''],
  ['매거진-연결시트-노티피케이션', 'https://zpl.io/anx3OLY', 'LinkSheetDetailScreen'],
  ['매거진-연결시트-노티피케이션-1', 'https://zpl.io/a71PlQW', 'LinkSheetDetailScreen'],
  ...
  ['매거진-연결시트-샌드아웃', 'https://zpl.io/br43YL5', 'LinkSheetScreen'],
  ...
  ['매거진-연결시트-전화걸기', 'https://zpl.io/adg34NE', 'LinkSheetDetailScreen'],
  ['검색', 'https://zpl.io/2vEAKpn', 'SearchScreen'],
  ['검색-1', 'https://zpl.io/VqdkKJY', 'SearchScreen'],
